...
export default function LongitudinalPatientRecordPage() {
  ...
  // Mocked enriched data representing longitudinal EHR
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-3">
        ...
        <span className="text-xs text-slate-400 font-medium">Back to Patient Intelligence Center</span>
      </div>
      ...
      <QuickActionsBar
        patientId={patientId}
        onGenerateSummary={() => alert("AI Summary re-generated by Agent 6 (InsightEngine)")}
        onSendFollowup={() => alert("Follow-up outreach triggered via Agent 4 (RetentionRadar)")}
      />
